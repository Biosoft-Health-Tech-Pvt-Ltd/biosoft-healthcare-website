  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="w-full px-4">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex space-x-8">
              <a href="#home" className="text-gray-700 hover:text-[#FF7A3D] transition-colors">
                Home
              </a>
              <a href="#about" className="text-gray-700 hover:text-[#FF7A3D] transition-colors">
                About
              </a>
              <a href="#services" className="text-gray-700 hover:text-[#FF7A3D] transition-colors">
                Products
              </a>
              <a href="#experiences" className="text-gray-700 hover:text-[#FF7A3D] transition-colors">
                Solutions
              </a>
              <a href="#contact" className="text-gray-700 hover:text-[#FF7A3D] transition-colors">
                Contact
              </a>
            </div>
            <Button className="bg-[#FF7A3D] hover:bg-[#e6692d] text-white hidden md:inline-block">Request Demo</Button>
            {/* Hamburger for mobile */}
            <button
              className="md:hidden p-2 rounded focus:outline-none focus:ring-2 focus:ring-[#FF7A3D]"
              onClick={() => setMobileMenuOpen(true)}
              aria-label="Open menu"
              aria-haspopup="true"
              aria-controls="mobile-menu"
            >
              <Menu className="h-7 w-7 text-[#FF7A3D]" />
            </button>
          </div>
        </div>
        {/* Mobile Menu Overlay */}
          ...
          <div className="fixed inset-0 z-50 flex" aria-modal="true" role="dialog" tabIndex={-1}>
            ...
            >
              <div className="flex items-center justify-between px-6 py-5 border-b">
                ...
                <button
                  className="p-2 rounded-full hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-[#FF7A3D]"
              ...
              <nav className="flex-1 flex flex-col gap-2 px-6 py-8" aria-label="Mobile Navigation">
                <a
                  href="#home"
                  className="block py-3 px-2 rounded text-gray-800 text-lg font-medium hover:bg-[#FF7A3D]/10 focus:bg-[#FF7A3D]/20 focus:outline-none"
                  onClick={() => setMobileMenuOpen(false)}
                >
                  Home
                </a>
                ...
                <Button className="bg-[#FF7A3D] hover:bg-[#e6692d] text-white mt-6 py-3 text-lg" onClick={() => setMobileMenuOpen(false)}>
                  Request Demo
                </Button>
              </nav>
            </div>
            ...
            <div className="animate-fade-slide-up">
              ...
              <div className="flex flex-col sm:flex-row gap-4 animate-fade-slide-up delay-300">
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="bg-white text-[#4A90E2] border-2 border-[#4A90E2] shadow-lg hover:bg-[#FF7A3D] hover:text-white hover:border-[#FF7A3D] px-8 py-3 font-semibold transition-colors"
        ...
        {videoModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm animate-fade-in">
            ...
            <div className="relative bg-white rounded-xl shadow-2xl max-w-2xl w-[90vw] p-0 animate-fade-slide-up">
              <button
                className="absolute top-2 right-2 z-10 p-2 rounded-full bg-white/80 hover:bg-white focus:outline-none focus:ring-2 focus:ring-[#FF7A3D]"
        ...
        <div className="w-full px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <Button className="bg-[#FF7A3D] hover:bg-[#e6692d] text-white px-8 py-3 animate-fade-in delay-300">Learn More</Button>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="w-full px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <Button className="bg-[#FF7A3D] hover:bg-[#e6692d] text-white px-8 py-3 animate-fade-in delay-300">Explore Innovation</Button>
            </div>
            <div className="relative animate-fade-in delay-200">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center">
                    ...
                    <div className="text-2xl font-bold text-[#4A90E2] animate-fade-in delay-100">85%</div>
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-2xl font-bold text-[#4CAF50] animate-fade-in delay-100">92%</div>
      ...
      <section className="py-20 bg-white">
        <div className="w-full px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-[#FF7A3D] mb-8 animate-fade-in">Engineering Healthier Futures</h2>
          </div>
      ...
      {/* Team Section */}
      <section className="py-24 bg-gradient-to-r from-blue-100 to-green-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
            ...
            <div className="bg-white rounded-xl p-10 md:p-14 shadow-2xl flex flex-col items-center transition-transform hover:scale-105">
              <img
                ...
                className="w-full h-80 md:h-[28rem] object-cover rounded-md border-8 border-[#4A90E2] shadow-md mb-8"
              />
              <h3 className="text-xl md:text-xl font-bold text-[#4A90E2] mb-3 animate-fade-in delay-100">Healthcare Technology Team</h3>
            ...
            <div className="bg-white rounded-xl p-10 md:p-14 shadow-2xl flex flex-col items-center transition-transform hover:scale-105">
              <img
                ...
                className="w-full h-80 md:h-[28rem] object-cover rounded-md border-8 border-[#FF7A3D] shadow-md mb-8"
              />
              <h3 className="text-xl md:text-xl font-bold text-[#FF7A3D] mb-3 animate-fade-in delay-100">Support & Implementation Team</h3>
            ...
            <div className="bg-white rounded-xl p-10 md:p-14 shadow-2xl flex flex-col items-center transition-transform hover:scale-105">
              <img
                ...
                className="w-full h-80 md:h-[28rem] object-cover rounded-md border-8 border-[#4CAF50] shadow-md mb-8"
              />
              <h3 className="text-xl md:text-xl font-bold text-[#4CAF50] mb-3 animate-fade-in delay-100">Strategy & Innovation Team</h3>
